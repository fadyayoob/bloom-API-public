...
urlpatterns = [
    ...
    path('api/cart', views.carte, name='carte'),
    path('api/checkout', views.checkoute, name='checkoute'),
    ...
    path('api/carte', views.Cart.as_view(), name='cart'),
    ...
    path('api/checkoute', views.Checkout.as_view(), name='checkout'),
]
